...
brewer2 = Brewer('Harviestoun Brewery', 'Established brewery using ingredients from the Scottish Highlands.')
...
beer2 = Beer('Schiehallion', 'Crisp lager with refreshing notes.', 'Lager', 25, 1.90, 3.50, brewer2)
beer_repository.save(beer2)
beer3 = Beer('Bitter and Twisted', 'Sweet malt and bitter hops in one bottle. Full bodied light ale style with a punch.', 'Golden Ale', 10, 1.75, 3.00, brewer2)
